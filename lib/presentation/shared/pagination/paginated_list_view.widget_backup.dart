...
class InheritedPaginatedListViewWidget<T> extends InheritedWidget {
  final T provider;
  const InheritedPaginatedListViewWidget({
    Key? key,
  ...
  @override
  bool updateShouldNotify(covariant InheritedPaginatedListViewWidget oldWidget) {
    return provider != oldWidget.provider;
  }

  static Type _typeOf<T>() => T;

  // static InheritedPaginatedListViewWidget? of(BuildContext context) {
  //   return context.dependOnInheritedWidgetOfExactType<InheritedPaginatedListViewWidget>();
  //   // return context.findAncestorWidgetOfExactType<InheritedPaginatedListViewWidget>();
  // }

  static T? of<T>(BuildContext context) =>
      context.dependOnInheritedWidgetOfExactType<InheritedPaginatedListViewWidget<T>>()?.provider;
}
...
class PaginatedListViewWidget<T> extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final ty = provider.runtimeType;
    InheritedPaginatedListViewWidget(child: Container(), provider: provider).provider;
    // InheritedPaginatedListViewWidget.of(context)!.provider;
    final res = InheritedPaginatedListViewWidget.of(context);
    res.runtimeType;
    ...
    ref.watch(res);
    ref.read(res.notifier).fetchNextBatch();
