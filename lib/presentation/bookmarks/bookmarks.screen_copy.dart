...
import 'package:xplore_bg_v2/presentation/shared/widgets/appbar_title.widget.dart';
...
class _BookmarksScreenState extends State<BookmarksScreen> with AutomaticKeepAliveClientMixin {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) => _button("Popular", Icons.favorite, Colors.blue),
  ...
  Widget _body() {
    final position = LatLng(41.84120, 23.48872);
    return FlutterMap(
      options: MapOptions(
        center: position,
        zoom: 15,
